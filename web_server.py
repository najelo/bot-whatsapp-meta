...
async def handle_message(request: Request):
    ...
    try:
        ...
        if 'messages' in value:
            ...
            # 1. GESTIÓN DE REACCIONES (Activa el estado de espera)
            if 'reaction' in msg:
            ...
            # 3. GESTIÓN DE IMÁGENES (Auditoría de pagos)
            elif 'image' in msg:
                ...
                if estado == "ESPERANDO_CAPTURE":
                    ...
                    whatsapp_utils.send_whatsapp_message(phone, "Por favor, utiliza una palabra clave o reacciona con un 💎 para iniciar el proceso de pago.")
