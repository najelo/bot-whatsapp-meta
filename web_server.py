...
async def recibir_notificacion(request: Request, background_tasks: BackgroundTasks):
    try:
        ...
        # =====================================================================
        # ENFOQUE CORRECTO: FILTRAR SEGÚN EL ESTADO PRIMERO
        # =====================================================================
        if estado and estado.startswith("ESPERANDO_CAPTURE_"):
            
            # Si el usuario envía la imagen esperada, procedemos con Gemini en BG
            ...
            # CORRECCIÓN CLAVE: Si manda CUALQUIER otra cosa (texto, audio, etc.) en pleno pago, lo bloqueamos
            else:
        ...
        # =====================================================================
        # CASO B: EL USUARIO ESTÁ LIBRE (ESTADO 'INICIO' O SIN REGISTRO)
        # =====================================================================
        # Manejo de reacciones con emojis para activar el flujo de pago
        ...
        # Respuestas automáticas por palabras clave en texto plano
        if msg.get("type") == "text":
            ...
            if respuestas_encontradas:
                ...
                whatsapp_utils.send_whatsapp_message(
                    phone, 
                    "Hola. Reacciona con un emoji a nuestros mensajes para iniciar el proceso de verificación de pago o escribe una palabra clave válida."
                )
            return "OK", 200

        # Respuestas por notas de voz
